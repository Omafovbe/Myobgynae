...
const HeroHome = () => {
  return (
    <section className="relative w-full" name="home">
      <div
        className="bg-cover bg-no-repeat w-full h-full absolute inset-0"
        style={{ backgroundImage: `url(${bgImage})` }}
      />
      <div
        className="relative h-scree max-w-[1300px] mx-auto px-4 sm:px-6"
        style={{ maxWidth: 1300 }}
      >
        <div className="grid lg:grid-cols-2 gap-y-6 pt-8 lg:pt-20 z-20">
          <div className="lg:col-span-1">
            <div className="flex flex-col space-y-6 pt-8">
              ...
              <h1
                className="h1 leading-loose font-extrabold font-poppins text-3xl lg:text-4xl xl:text-5xl"
                style={{ lineHeight: 1.5 }}
              >
                Take Care of Your <br />{' '}
                <span className="text-primary-900 ">Baby as well as your</span>{' '}
                Health Here
              </h1>
