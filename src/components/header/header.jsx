      ...
      >
        <div className="max-w-full mx-auto px-4 lg:px-16 xl:px-20 py-4">
          <div className="flex flex-wrap items-center justify-between">
            <Link className="flex items-center space-x-3" onClick={toggleHome}>
              ...
              <ul className="ipad:flex ipad:space-y-0 ipad:flex-grow ipad:flex-row ipad:flex-wrap ipad:space-x-10 ipad:items-center ">
                <li>
                  <LinkScroll
                    ...
                    offset={-80}
                    activeClass="active"
                    className="text-grayish-900 font-semibold hover:text-primary-900 cursor-pointer"
                  >
                    Home
                  </LinkScroll>
                </li>
              ...
              <ul className="flex items-center space-x-12">
                ...
                <li>
                  <NavLink
                    ...
                    className="text-grayish-900 font-semibold hover:text-primary-900"
                  >
                    Login
                  </NavLink>
                </li>
          ...
          <div
            className={`${
              open
                ...
                : 'hidden'
            } bg-white px-4 py-5 pt-6 w-full  rounded h-full overflow-y-auto transition-all duration-300 ease-out z-50 ipad:hidden`}
          >
